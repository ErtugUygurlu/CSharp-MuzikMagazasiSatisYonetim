...
namespace MuzikEnstrumanSatis
{
    public partial class Bilgi : Form
    {
        ...
        private void uyeler()//datagritten seçim yapmak için
        {
            baglanti.Open();
        ...
        private void Filter()// filtreleme
        {
            baglanti.Open();
        ...
        private void BilgiDgv_CellContentClick_1(object sender, DataGridViewCellEventArgs e) // seçtiklerin textboxlara gelir
        {
            EnsKey = Convert.ToInt32(BilgiDgv.SelectedRows[0].Cells[0].Value.ToString());
        ...
        private void button5_Click(object sender, EventArgs e)//şifre güncelleme
        {
